...
public class Crescendo extends Line {
    ...
    public <Anchor> void draw(MusicCanvas<Anchor> canvas, Map<Chord, ChordAnchors<Anchor>> chordAnchorsMap) {
        ...
        canvas.drawLine(canvas.getAnchor(startPosition), 0, -1.5f, canvas.getAnchor(endPosition), 0, -1, .1f);
        canvas.drawLine(canvas.getAnchor(startPosition), 0, -1.5f, canvas.getAnchor(endPosition), 0, -2, .1f);
    }
}
